// -*- coding: utf-8 -*-
// @Time    : 2025/1/23 22:53
// @Author  : HeLong
// @FileName: optimized_tts_worker.js
// @Software: PyCharm
// @Blog    ：https://blog.duolaa.asia/
// A TTS Server On Cloudflare Workers
...
async function getVoice(text, voiceName, rate, pitch, volume, style, outputFormat) {
    try {
        ...
        return errorResponse(error, voiceName);
    }
}
...
// 错误响应生成函数
function errorResponse(error, voiceName) {
